...
const ICON = { '/console/reps': 'users', '/console': 'quotation', '/console/marketing': 'platform', '/console/churn': 'deals', '/console/methodology': 'settings', '/console/admin/upload': 'queue', '/console/admin/users': 'users' };
...
export const DEFAULT_TABS = [
  ...
  { href: '/console/marketing', label: 'Marketing', min_role: 'admin', sort: 25 },
