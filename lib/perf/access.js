...
export const DEFAULT_TABS = [
  { href: '/console/reps', label: 'Sales Reps', min_role: 'user', sort: 10 },
  { href: '/console', label: 'Company', min_role: 'admin', sort: 20 },
...
export const navFor = (tabs, role) => tabs.filter((t) => visible(t, role)).map((t) => ({ href: t.href, label: t.label, icon: ICON[t.href] || 'quotation' }));
