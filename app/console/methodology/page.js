    ...
    <div>
      ...
      <div className="card" style={{ marginBottom: 18 }}>
        ...
        <table className="list"><tbody>
          ...
          <Row k="SOMs" v="Angela Hamilton and Paige Givinsky are Sales Operations Managers. Their MQLs, SQLs and booked meetings count in every company total, but they do not appear on the Sales Reps dashboard at all." />
