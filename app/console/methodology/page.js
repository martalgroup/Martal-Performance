    ...
    <div>
      ...
      <div className="card" style={{ marginBottom: 18 }}>
        ...
        <table className="list"><tbody>
          ...
          <Row k="Not ranked" v="Angela Hamilton and Paige Givinsky are Sales Operations Managers. Their MQLs, SQLs and booked meetings count in every company total, but they are not ranked against the SDRs; their rows appear unranked at the foot of the leaderboard." />
