  ...
  return (
    <div>
      ...
      <div className="card" style={{ marginBottom: 18 }}>
        ...
        <table className="list"><thead><tr><th>#</th><th>Rep</th><th style={{ textAlign: 'right' }}>Accounts</th><th style={{ textAlign: 'right' }}>MQLs</th><th style={{ textAlign: 'right' }}>SQLs</th><th style={{ textAlign: 'right' }}>Meetings</th></tr></thead>
          <tbody>{table.map((r) => (
      ...
      <div className="card">
        <h2 style={{ fontSize: 18, margin: '0 0 12px', borderLeft: '3px solid var(--mg-blue-500)', paddingLeft: 10 }}>Booked meetings by rep, last {periods.length} periods</h2>
